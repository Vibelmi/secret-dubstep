...
<div>
<h1>-{$Content.name}</h1>
<div id="content"><img style="width:100%;" src="http://{$globals.HOST}{$globals.SUBFOLDER}{$Content.img}"><b style="display:block;margin:10px 0px;">{$Content.description.short}</b><br>
